...
urchins[[1]] # need to use double brackets if you want what is in list. 
             # ie: single brackets -> single element list, double brackets -> character "blue"
